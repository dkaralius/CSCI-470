 ...
 ************************************************************/ 
/**
 * AnimationApp is the main application. Starts by initializing 
 * buttons and a list. Sets up the GUI and adds the components.
 * Reads the .txt file and parses the information into animation
 * objects, which are then added to a vector and sorted by 
 * descending animation name. The vector is then added to a JList.
 * Has a try/catch for reading the file. Contains event handling for
 * buttons.
*/
